...
#### Технические задачи
- [x] Настройка инфраструктуры (PostgreSQL, Redis)
...
- [ ] Пользователь может создать тикет за < 30 секунд
- [ ] Персонал получает уведомление о новом тикете  
- [ ] Ответ в тикете доходит до пользователя в Telegram
- [ ] Система выдерживает 50+ одновременных пользователей
- [ ] Mini App работает стабильно на iOS и Android

---

### 🔧 Этап 2: Расширенная функциональность (3-4 недели) - v1.1
...
- 🆕 **Система категорий**
  ...
  - Автоназначение по категориям
  
- 🆕 **Приоритеты тикетов**
  - 4 уровня: Низкий, Обычный, Высокий, Критический
  - Автоприоритизация по ключевым словам
  - SLA-таймеры по приоритетам
  
- 🆕 **Расширенные уведомления**
  - Кастомизируемые шаблоны сообщений
  - Уведомления по email (опционально)
  - Напоминания о неотвеченных тикетах
  - Групповые уведомления для персонала
  
- 🆕 **Файловые вложения**
  - Загрузка изображений, документов, архивов
  - Превью изображений в чате
  - Ограничения по размеру и типу файлов
  - Антивирусная проверка (интеграция с ClamAV)
